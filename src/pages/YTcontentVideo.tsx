...
import UploadYTContentVideoModal from "@/components/UploadYTContentVideo";
...
export default function YTContentVideos() {
  ...
  const getYTContentVideos = async () => {
    try {
  ...
  const handleDelete = async (videoId: string) => {
    ...
    try {
      await deleteData(`/api/ytContentVideo/${videoId}`, auth.token);
                    ...
                    <TableCell>
                      ...
                      <iframe
                        ...
                        src={`https://www.youtube.com/embed/${
                          content.video_url.split("/").pop().split("?")[0]
                        }`}
                        // src={content.video_url.split("/").pop().split("?")[0]}
